...
class TablatScreen extends StatefulWidget {
  const TablatScreen({super.key});

  @override
  State<TablatScreen> createState() => _TablatScreenState();
}

class _TablatScreenState extends State<TablatScreen> {
